/**
 * avadbot browse server — persistent Chromium daemon
 *
 * Architecture:
 ...
 *
 * State:
 *   State file: <project-root>/.avadbot/browse.json (set via BROWSE_STATE_FILE env)
 *   Log files:  <project-root>/.avadbot/browse-{console,network,dialog}.log
...
function generateHelpText(): string {
  ...
  const lines = ['avadbot browse — headless browser for AI agents', '', 'Commands:'];
