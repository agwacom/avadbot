...
description: |
  ...
  Do NOT use for automated CI pipelines, non-browser tasks, or general code execution —
  this is an interactive browser tool for QA and dogfooding.
argument-hint: "<command> [args]  (e.g. goto <url>, snapshot -i, click @e3)"
allowed-tools:
  - Bash
  - Read
  - AskUserQuestion
...
# avad-browse: QA Testing & Dogfooding
