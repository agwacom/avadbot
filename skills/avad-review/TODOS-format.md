...
Shared reference for the canonical TODOS.md format. Referenced by `/avad-ship` (Step 5.5) and `/avad-plan-ceo-review` (TODOS.md updates section) to ensure consistent TODO item structure.
