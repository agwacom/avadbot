...
description: |
  ...
  /avad-freeze (blocks edits outside a specified directory). Use for maximum safety
...
hooks:
  PreToolUse:
    - matcher: "Bash"
      hooks:
        - type: command
          command: "bash ${CLAUDE_SKILL_DIR}/../avad-careful/bin/check-careful.sh"
...
- "To remove the edit boundary, run `/avad-unfreeze`. To deactivate everything, end the session."

## What's protected

See `/avad-careful` for the full list of destructive command patterns and safe exceptions.
