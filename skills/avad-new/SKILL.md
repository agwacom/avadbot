...
Scan the project broadly — not just the 16 target files but **any existing files** that
provide context about the project (plans, docs, notes, prior scaffolding).
...
If context files were discovered, pre-fill Phase 2 answers where possible (project name,
problem, user, stack) — the user can confirm or override during Product Discovery.
...
**Progressive checkoff:** After writing each file, immediately update `TODOS.md` to mark
...
`TODOS.md` was already created in Phase 0.5 as the scaffolding checklist. In this step,
